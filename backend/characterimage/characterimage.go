...
type CharacterImageDatabase interface {
	CreateBodyType(context.Context, *BodyType) (ID, error)
	GetBodyType(context.Context, ID) (*BodyType, error)
	ListBodyTypes(context.Context, *BodyTypesFilter) ([]BodyType, error)

	CreateStaticPart(context.Context, *StaticPart) (ID, error)
	GetStaticPart(context.Context, ID) (*StaticPart, error)
	ListStaticParts(context.Context, *StaticPartsFilter) ([]StaticPart, error)

	CreateDynamicPart(context.Context, *DynamicPart) (ID, error)
	GetDynamicPart(context.Context, ID) (*DynamicPart, error)
	ListDynamicParts(context.Context, *DynamicPartsFilter) ([]DynamicPart, error)

	CreateProp(context.Context, *Prop) (ID, error)
	GetProp(context.Context, ID) (*Prop, error)
	ListProps(context.Context, *PropsFilter) ([]Prop, error)

	CreateAnimation(context.Context, *Animation) (ID, error)
	GetAnimation(context.Context, ID) (*Animation, error)
	ListAnimations(context.Context, *AnimationsFilter) ([]BodyType, error)
}
