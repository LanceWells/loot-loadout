...
Table: animation_frame_static_position
...
JSON Sample
-------------------------------------
{    "animation_frame_id": 79,    "part_type": "cPTLUQNLPoNCotvEoXMRoyyhl",    "x": 3,    "y": 84,    "rotation": 42}



*/

// AnimationFrameStaticPosition struct is a row record of the animation_frame_static_position table in the charimage database
...
var animation_frame_static_positionTableInfo = &TableInfo{
	Name: "animation_frame_static_position",
	Columns: []*ColumnInfo{
...
func (a *AnimationFrameStaticPosition) TableName() string {
	return "animation_frame_static_position"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *AnimationFrameStaticPosition) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *AnimationFrameStaticPosition) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *AnimationFrameStaticPosition) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *AnimationFrameStaticPosition) TableInfo() *TableInfo {
	return animation_frame_static_positionTableInfo
}
